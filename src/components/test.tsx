            ...
            <div key={category} className="mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                {categoryProperties.map((property, index) => (
                  <div
                    key={`${category}-${index}`}
                    className="group bg-slate-800 rounded-xl overflow-hidden shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-3xl border border-slate-700"
                  >
                    {/* Image Container */}
                      ...
                      <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                        <div className="flex gap-3">
                          <button
                            ...
                            className="bg-amber-500 hover:bg-amber-600 text-black p-3 rounded-full transition-colors duration-200 shadow-lg"
                          >
                            <Eye size={20} />
                          </button>
                          {property.location && (
                            <button
                              ...
                              className="bg-blue-500 hover:bg-blue-600 text-white p-3 rounded-full transition-colors duration-200 shadow-lg"
                            >
                              <MapPin size={20} />
                            </button>
                          )}
                    ...
                    {/* Content */}
                    <div className="p-6">
                      <h4 className="text-xl font-bold text-amber-400 mb-3 line-clamp-2 group-hover:text-amber-300 transition-colors">
                        {property.title}
                      </h4>
                      ...
                      <div className="flex gap-2 mt-auto">
                        <button
                          onClick={() => setSelectedImage(property.image)}
                          className="flex-1 bg-slate-700 hover:bg-slate-600 text-white py-2 px-4 rounded-lg transition-colors duration-200 text-sm font-medium"
                        >
                        ...
                        {property.location && (
                          <button
                            onClick={() => handleLocationClick(property.location!)}
                            className="flex-1 bg-amber-500 hover:bg-amber-600 text-black py-2 px-4 rounded-lg transition-colors duration-200 text-sm font-medium"
                          >
      ...
      {selectedImage && (
        ...
        >
          <div className="relative max-w-7xl max-h-full">
            <button
              onClick={() => setSelectedImage(null)}
              className="absolute top-4 right-4 text-white bg-black bg-opacity-70 rounded-full p-3 hover:bg-opacity-90 transition-colors z-10 shadow-lg"
            >
              <X size={24} />
            </button>
            <img
