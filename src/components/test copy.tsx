...
import { X, MapPin, Eye, ArrowRight, Star, Calendar, Building } from 'lucide-react';
...
const Properties: React.FC = () => {
  ...
  const categories = [
    { id: 'all', name: 'جميع العقارات', icon: Building },
    { id: 'current', name: 'العقارات الحالية', icon: Star },
    { id: 'complexes', name: 'المجمعات', icon: Building },
    { id: 'residential', name: 'السكنية', icon: Building },
    { id: 'previous', name: 'السابقة', icon: Calendar },
    { id: 'construction', name: 'الإنشاءات', icon: Building }
  ];
    ...
    <section id="properties" className="py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-3 bg-gradient-to-r from-amber-500/20 to-amber-600/20 backdrop-blur-sm border border-amber-500/30 rounded-full px-6 py-3 mb-6">
            <Building className="w-5 h-5 text-amber-400" />
            <span className="text-amber-400 font-medium">محفظة العقارات المميزة</span>
          </div>
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            استكشف مجموعتنا المتميزة من العقارات الفاخرة والمشاريع الاستثنائية التي تعكس رؤيتنا في التطوير العقاري
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
          {filteredProperties.map((property, index) => {
            const cardId = `${property.category}-${index}`;
            ...
            return (
              ...
              >
                ...
                <div className="absolute top-4 right-4 z-20">
                  <div className="flex items-center gap-1 bg-black/60 backdrop-blur-sm text-white px-3 py-1 rounded-full text-sm font-medium">
                    <Calendar size={14} />
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-slate-700/50">
                    <button
                      onClick={() => setSelectedImage(property.image)}
                      className="flex items-center gap-2 text-amber-400 hover:text-amber-300 transition-colors duration-200 text-sm font-medium"
                    >
